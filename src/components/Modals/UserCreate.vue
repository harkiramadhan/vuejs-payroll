<template>
<div>
    <button class="bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-xs px-2 py-1 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 ml-1" type="button" v-on:click="toggleModal()">
        <i class="fas fa-plus mr-2 ml-1"></i><span class="mr-2">Add</span>
    </button>
