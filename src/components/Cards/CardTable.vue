        ...
        <table class="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
                        <div class="flex">
                            <img :src="team1" alt="..." class="w-10 h-10 rounded-full border-2 border-gray-100 shadow" />
                            <img :src="team2" alt="..." class="w-10 h-10 rounded-full border-2 border-gray-100 shadow -ml-4" />
                            <img :src="team3" alt="..." class="w-10 h-10 rounded-full border-2 border-gray-100 shadow -ml-4" />
                            <img :src="team4" alt="..." class="w-10 h-10 rounded-full border-2 border-gray-100 shadow -ml-4" />
                        </div>
                    </td>
                    <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4">
