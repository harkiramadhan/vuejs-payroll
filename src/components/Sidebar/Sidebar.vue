    ...
    <div class="md:flex-col md:items-stretch md:min-h-full md:flex-no-wrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded" v-bind:class="collapseShow">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                <li class="items-center">
                    <router-link class="text-gray-800 hover:text-gray-600 text-xs uppercase py-3 font-bold block" to="/auth/login">
                ...
                <li class="items-center">
                    <router-link class="text-gray-800 hover:text-gray-600 text-xs uppercase py-3 font-bold block" to="/auth/register">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                <li class="inline-flex">
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/vue/colors/webapp" target="_blank" class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold">
                ...
                <li class="inline-flex">
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/vue/alerts/webapp" target="_blank" class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold">
                ...
                <li class="inline-flex">
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/angular/overview/webapp" target="_blank" class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold">
                ...
                <li class="inline-flex">
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/js/overview/webapp" target="_blank" class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold">
                ...
                <li class="inline-flex">
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/nextjs/overview/webapp" target="_blank" class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold">
                ...
                <li class="inline-flex">
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/react/overview/webapp" target="_blank" class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold">
                        <i class="fab fa-react mr-2 text-gray-400 text-base"></i>
                        React
                    </a>
                </li>
                ...
                <li class="inline-flex">
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/svelte/overview/webapp" target="_blank" class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold">
                ...
                <li class="inline-flex">
                    <a href="https://www.creative-tim.com/learning-lab/tailwind/vue/overview/webapp" target="_blank" class="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold">
